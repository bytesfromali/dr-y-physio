        ...
        <div className={styles.twoColumnLayout}>
          <div className={styles.seoContent}>
            ...
            <p>
              ...
              services that include in-clinic treatments, home visits, and
            ...
            <p>
              With state-of-the-art facilities and a patient-centric approach,
              we ensure personalized care tailored to your needs. Choose Dr. Y
              Physio for expert care and a commitment to your well-being.
            </p>
          </div>
